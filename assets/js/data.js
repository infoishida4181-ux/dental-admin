...
const DEFAULT_ENTRIES=[
  ...
  {id:9, name:'医療DX推進体制整備加算',abbr:'医療ＤＸ',number:'第610058号',date:'2024-07-01',category:'basic',status:'red',kaitei:'expire',memo:'令和8年6月廃止・再編。電子的歯科診療情報連携体制加算への移行が必要。'},
];
